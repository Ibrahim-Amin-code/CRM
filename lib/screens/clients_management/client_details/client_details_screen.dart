  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Center(child: Text('Client Details',style:Theme.of(context).textTheme.bodyText2,)),
        leading: InkWell(
      ...
      body: ListView(
        ...
        children: [
          ...
          SizedBox(height: 10,),
          Text('Client Address *',style: Theme.of(context).textTheme.bodyText1,),
          SizedBox(height: 5,),
          buildClientDetailsFormField(
            context: context,
            type: TextInputType.text,
          ...
          Container(
            height: 150,
            child: buildClientDetailsFormField(
              context: context,
              type: TextInputType.text,
